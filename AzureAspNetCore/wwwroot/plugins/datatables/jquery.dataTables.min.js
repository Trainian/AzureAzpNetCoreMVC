...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Первый",sLast:"Last",sNext:"Вперед",sPrevious:"Назад"},sEmptyTable:"База пуста",sInfo:"Показано с _START_ по _END_ из _TOTAL_ сущьностей",sInfoEmpty:"Показано с 0 по 0 из 0 сущьностей",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_",sLoadingRecords:"Загрузка...",sProcessing:"В процессе...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Ничего не найдено"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
